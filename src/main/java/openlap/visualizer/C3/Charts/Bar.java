package openlap.visualizer.C3.Charts;
...
import openlap.visualizer.C3.Transformers.PairList;
 ...
 * on 17-Mar-16.
 */
public class Bar extends VisualizationCodeGenerator {
    ...
    public void initializeDataSetConfiguration() {
        ...
        try {
            ...
            this.getInput().addOpenLAPDataColumn(
                    OpenLAPDataColumnFactory.createOpenLAPDataColumnOfType("yAxisValues", OpenLAPColumnDataType.Numeric, true, "Y-Axis Values", "List of items to be displayed on Y-Axis of the graph")
            );
    ...
    public String visualizationCode(DataTransformer dataTransformer, Map<String, Object> map) throws VisualizationCodeGenerationException {
        ...
        //stringBuilder.append("bar:{width:{ratio:0.5}}, ");
